 ...
 * 
 * Simply place it in the folder where you have your own .java files, and use it
 ...
 * 
 *          Usage: -- Oblig3Precode precode = new Oblig3Precode(n);
 * 
 *          <Do this in a loop fitting your program and how you store the
 *          results> precode.addFactor(3999999999999999999L, 3);
