 ...
 *       HOW TO USE THIS:
 * 
 *       To get the matrices you are going to multiply: (Remember to read 'seed'
 *       and 'n' from the command line arguments)
 * 
 *       double[][] A = Oblig2Precode.generateMatrixA(seed,n); double[][] B =
 *       Oblig2Precode.generateMatrixB(seed,n);
 * 
 *       (Notice it's two different methods)
 * 
 *       Then do your multiplications in the various ways: - Sequential with no
 *       transpose - Sequential with A transposed - Sequential with B transposed
 *       - Parallel with no transpose - Parallel with A transposed - Parallel
 *       with B transposed
 * 
 ...
 *
 *       1.35 2.27 1.73 1.07 1.69 1.42 2.35 1.95 0.98 1.72 1.19 2.14 1.87 1.09
 *       1.47 0.92 1.90 1.87 1.21 1.53 1.22 2.17 1.61 0.97 1.65
 *
 * 
 * 
 *
...
class Oblig2Precode {
	 ...
	 */
	public enum Mode {
		SEQ_NOT_TRANSPOSED, SEQ_A_TRANSPOSED, SEQ_B_TRANSPOSED, PARA_NOT_TRANSPOSED, PARA_A_TRANSPOSED,
		PARA_B_TRANSPOSED
	}
